...
def test_szlab_mixer_ui_preset_uses_current_csv_and_s04_s05_actions():
    ...
    assert graph_nodes["szlab_poly_plc"]["config"]["csv_path"].endswith(
        "szlab_plc_0702.csv"
    )
...
def test_szlab_robot_action_workflow_does_not_auto_apply_debug_sensor_skips(
    monkeypatch,
):
