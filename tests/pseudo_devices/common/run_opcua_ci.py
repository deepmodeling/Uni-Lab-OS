...
DEFAULT_MANIFEST_GLOB = "tests/pseudo_devices/**/ci.json"
SERVER_SCRIPT = REPO_ROOT / "tests" / "pseudo_devices" / "common" / "opcua_csv_server.py"
DAEMON_SCRIPT = REPO_ROOT / "tests" / "pseudo_devices" / "common" / "opcua_flow_daemon.py"
