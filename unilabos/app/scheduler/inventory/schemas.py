...
class MaterialOutputRegisterPayload(WireModel):
    template_id: NonEmptyString
    ...
    slot_id: str = ""
    lot_id: Optional[NonEmptyString] = None
    task_id: Optional[NonEmptyString] = None
    run_id: Optional[NonEmptyString] = None
    action_id: Optional[NonEmptyString] = None
    output_name: str = ""


class MaterialContentConsumePayload(WireModel):
    edge_uuid: NonEmptyString
    quantity: PositiveQuantity
    quantity_key: NonEmptyString = "quantity"
    unit: str = ""
...
class MaterialOutputRegisterCommand(InventoryCommandBase):
    type: Literal["material.output.register"]
    payload: MaterialOutputRegisterPayload


class MaterialContentConsumeCommand(InventoryCommandBase):
    type: Literal["material.content.consume"]
    payload: MaterialContentConsumePayload
...
InventoryCommand = Annotated[
    Union[
        ...
        ContentSetCommand,
        ContentClearCommand,
        MaterialOutputRegisterCommand,
        MaterialContentConsumeCommand,
...
__all__ = [
    ...
    "MaterialOutputRegisterPayload",
    "MaterialContentConsumePayload",
