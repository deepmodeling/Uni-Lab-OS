...
class ReachabilityParam(object):
    ...
    def __init__(self, result=None, index=None, singularity_type=None,):
        self.result = result
        self.index = index
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.singularity_type = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.singularity_type is not None:
            oprot.writeFieldBegin('singularity_type', TType.I32, 3)
            oprot.writeI32(self.singularity_type)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.singularity_type is None:
            raise TProtocolException(message='Required field singularity_type is unset!')
        return
...
class EAxissInfo(object):
    ...
    def __init__(self, index=None, status=None, pos=None, vel=None, acc=None,):
        self.index = index
        self.status = status
        self.pos = pos
        self.vel = vel
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.index = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if self.acc is not None:
            oprot.writeFieldBegin('acc', TType.DOUBLE, 5)
...
class EAxisSchemesParam(object):
    """
    Attributes:
     - name
     - eaxis_status
    ...
    def __init__(self, name=None, eaxis_status=None, eaxis_pos=None, end_pos=None, active=None, valid=None,):
        self.name = name
        self.eaxis_status = eaxis_status
        self.eaxis_pos = eaxis_pos
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i305 in range(_size301):
                        ...
                        self.eaxis_status.append(_elem306)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i311 in range(_size307):
                        ...
                        self.eaxis_pos.append(_elem312)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('EAxisSchemesParam')
        if self.name is not None:
            oprot.writeFieldBegin('name', TType.STRING, 1)
            oprot.writeString(self.name.encode('utf-8') if sys.version_info[0] == 2 else self.name)
            oprot.writeFieldEnd()
        if self.eaxis_status is not None:
            oprot.writeFieldBegin('eaxis_status', TType.LIST, 2)
            oprot.writeListBegin(TType.I32, len(self.eaxis_status))
            for iter319 in self.eaxis_status:
                oprot.writeI32(iter319)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.eaxis_pos is not None:
            oprot.writeFieldBegin('eaxis_pos', TType.LIST, 3)
            oprot.writeListBegin(TType.DOUBLE, len(self.eaxis_pos))
            for iter320 in self.eaxis_pos:
                oprot.writeDouble(iter320)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.end_pos is not None:
            oprot.writeFieldBegin('end_pos', TType.LIST, 4)
            oprot.writeListBegin(TType.DOUBLE, len(self.end_pos))
            for iter321 in self.end_pos:
        ...
        if self.valid is not None:
            oprot.writeFieldBegin('valid', TType.BOOL, 6)
    ...
    def validate(self):
        ...
        if self.eaxis_status is None:
            raise TProtocolException(message='Required field eaxis_status is unset!')
        if self.eaxis_pos is None:
            raise TProtocolException(message='Required field eaxis_pos is unset!')
        if self.end_pos is None:
            raise TProtocolException(message='Required field end_pos is unset!')
...
class RealTimeControlData(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i326 in range(_size322):
                        ...
                        self.joint_pos_cmd.append(_elem327)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i332 in range(_size328):
                        ...
                        self.joint_vel_cmd.append(_elem333)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i338 in range(_size334):
                        _elem339 = iprot.readDouble()
                        self.joint_torq_cmd.append(_elem339)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i344 in range(_size340):
                        ...
                        self.cart_pos_tool_wobj_cmd.append(_elem345)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i350 in range(_size346):
                        ...
                        self.cart_vel_tool_wobj_cmd.append(_elem351)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i356 in range(_size352):
                        ...
                        self.cart_ft_cmd.append(_elem357)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.joint_pos_cmd is not None:
            ...
            for iter358 in self.joint_pos_cmd:
                oprot.writeDouble(iter358)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.joint_vel_cmd is not None:
            ...
            for iter359 in self.joint_vel_cmd:
                oprot.writeDouble(iter359)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.cart_pos_tool_wobj_cmd is not None:
            ...
            for iter361 in self.cart_pos_tool_wobj_cmd:
                oprot.writeDouble(iter361)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.cart_vel_tool_wobj_cmd is not None:
            ...
            for iter362 in self.cart_vel_tool_wobj_cmd:
                oprot.writeDouble(iter362)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.cart_ft_cmd is not None:
            ...
            for iter363 in self.cart_ft_cmd:
...
class PointOp(object):
    ...
    def __init__(self, pos=None, op=None, vel=None, blend_time=None, dwell_time=None,):
        self.pos = pos
        self.op = op
        self.vel = vel
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.DOUBLE:
                    self.blend_time = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.DOUBLE:
                    self.dwell_time = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.vel is not None:
            ...
            oprot.writeDouble(self.vel)
            oprot.writeFieldEnd()
        if self.blend_time is not None:
            oprot.writeFieldBegin('blend_time', TType.DOUBLE, 4)
            oprot.writeDouble(self.blend_time)
            oprot.writeFieldEnd()
        if self.dwell_time is not None:
            oprot.writeFieldBegin('dwell_time', TType.DOUBLE, 5)
            oprot.writeDouble(self.dwell_time)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TrajTimeParam(object):
    ...
    def __init__(self, start=None, target=None, middle=None, qnear=None, type=None, vel=None, acc=None, circle=None, scale=None, tool=None, wobj=None,):
        self.start = start
        self.target = target
        self.middle = middle
        self.qnear = qnear
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i387 in range(_size383):
                        _elem388 = iprot.readDouble()
                        self.middle.append(_elem388)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TrajTimeParam')
        if self.start is not None:
            oprot.writeFieldBegin('start', TType.LIST, 1)
            oprot.writeListBegin(TType.DOUBLE, len(self.start))
            for iter395 in self.start:
                oprot.writeDouble(iter395)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.target is not None:
            oprot.writeFieldBegin('target', TType.LIST, 2)
            oprot.writeListBegin(TType.DOUBLE, len(self.target))
            for iter396 in self.target:
                oprot.writeDouble(iter396)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.middle is not None:
            oprot.writeFieldBegin('middle', TType.LIST, 3)
            oprot.writeListBegin(TType.DOUBLE, len(self.middle))
            for iter397 in self.middle:
                oprot.writeDouble(iter397)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.qnear is not None:
            oprot.writeFieldBegin('qnear', TType.LIST, 4)
            oprot.writeListBegin(TType.DOUBLE, len(self.qnear))
            for iter398 in self.qnear:
        ...
        if self.type is not None:
            ...
            oprot.writeFieldEnd()
        if self.vel is not None:
            oprot.writeFieldBegin('vel', TType.DOUBLE, 6)
            oprot.writeDouble(self.vel)
            oprot.writeFieldEnd()
        if self.acc is not None:
            oprot.writeFieldBegin('acc', TType.DOUBLE, 7)
            oprot.writeDouble(self.acc)
            oprot.writeFieldEnd()
        if self.circle is not None:
            oprot.writeFieldBegin('circle', TType.BOOL, 8)
            oprot.writeBool(self.circle)
            oprot.writeFieldEnd()
        if self.scale is not None:
            oprot.writeFieldBegin('scale', TType.I32, 9)
    ...
    def validate(self):
        ...
        if self.middle is None:
            raise TProtocolException(message='Required field middle is unset!')
        if self.qnear is None:
            raise TProtocolException(message='Required field qnear is unset!')
        if self.type is None:
            raise TProtocolException(message='Required field type is unset!')
        if self.vel is None:
            raise TProtocolException(message='Required field vel is unset!')
        ...
        if self.circle is None:
            raise TProtocolException(message='Required field circle is unset!')
        ...
        if self.wobj is None:
            raise TProtocolException(message='Required field wobj is unset!')
        return
...
class PathOffsetResult(object):
    ...
    def __init__(self, path_result=None, status_code=None,):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i403 in range(_size399):
                        ...
                        for _i409 in range(_size405):
                            _elem410 = iprot.readDouble()
                            _elem404.append(_elem410)
                        iprot.readListEnd()
                        self.path_result.append(_elem404)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('PathOffsetResult')
        if self.path_result is not None:
            oprot.writeFieldBegin('path_result', TType.LIST, 1)
            oprot.writeListBegin(TType.LIST, len(self.path_result))
            for iter411 in self.path_result:
                oprot.writeListBegin(TType.DOUBLE, len(iter411))
                for iter412 in iter411:
    ...
    def validate(self):
        if self.path_result is None:
            raise TProtocolException(message='Required field path_result is unset!')
...
ReachabilityParam.thrift_spec = (
    ...
    (3, TType.I32, 'singularity_type', None, None, ),  # 3
)
all_structs.append(EAxissInfo)
EAxissInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'index', 'UTF8', None, ),  # 1
    (2, TType.I32, 'status', None, None, ),  # 2
    (3, TType.DOUBLE, 'pos', None, None, ),  # 3
    (4, TType.DOUBLE, 'vel', None, None, ),  # 4
    (5, TType.DOUBLE, 'acc', None, None, ),  # 5
)
all_structs.append(EAxisSchemesParam)
EAxisSchemesParam.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'name', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'eaxis_status', (TType.I32, None, False), None, ),  # 2
    (3, TType.LIST, 'eaxis_pos', (TType.DOUBLE, None, False), None, ),  # 3
    (4, TType.LIST, 'end_pos', (TType.DOUBLE, None, False), None, ),  # 4
    (5, TType.BOOL, 'active', None, None, ),  # 5
    (6, TType.BOOL, 'valid', None, None, ),  # 6
)
...
PointOp.thrift_spec = (
    ...
    (4, TType.DOUBLE, 'blend_time', None, None, ),  # 4
    (5, TType.DOUBLE, 'dwell_time', None, None, ),  # 5
)
all_structs.append(TrajTimeParam)
TrajTimeParam.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'start', (TType.DOUBLE, None, False), None, ),  # 1
    (2, TType.LIST, 'target', (TType.DOUBLE, None, False), None, ),  # 2
    (3, TType.LIST, 'middle', (TType.DOUBLE, None, False), None, ),  # 3
    (4, TType.LIST, 'qnear', (TType.DOUBLE, None, False), None, ),  # 4
    (5, TType.I32, 'type', None, None, ),  # 5
    (6, TType.DOUBLE, 'vel', None, None, ),  # 6
    (7, TType.DOUBLE, 'acc', None, None, ),  # 7
    (8, TType.BOOL, 'circle', None, None, ),  # 8
    (9, TType.I32, 'scale', None, None, ),  # 9
    (10, TType.STRING, 'tool', 'UTF8', None, ),  # 10
    (11, TType.STRING, 'wobj', 'UTF8', None, ),  # 11
)
all_structs.append(PathOffsetResult)
PathOffsetResult.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'path_result', (TType.LIST, (TType.DOUBLE, None, False), False), None, ),  # 1
