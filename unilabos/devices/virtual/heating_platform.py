...
class VirtualHeatingPlatform:
    ...
    def _ensure_demo_materials(self) -> None:
        ...
        self._ensure_template(
            ...
            resource_type="ItemizedCarrier",
            class_name="ItemizedCarrier",
            module_name="unilabos.resources.presets.itemized_carrier",
            category=["virtual_device", "heating"],
            available_sites=site_definitions,
        )
        self._ensure_template(
            "virtual_heating_sample",
                    ...
                    nodes=[
                        MaterialNodeCreate(
                            ...
                            identity=MaterialIdentityWrite(
                                ...
                                name=f"三工位虚拟加热平台 · {self.device_id}",
                        ...
                        nodes=[
                            MaterialNodeCreate(
                                ...
                                identity=MaterialIdentityWrite(
                                    ...
                                    name=f"加热样品 {self.device_id} · {index}",
