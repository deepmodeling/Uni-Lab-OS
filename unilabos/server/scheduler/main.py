"""Edge scheduler 独立进程入口。
    ...
    python -m unilabos.server.scheduler.main
    # 或
    uvicorn "unilabos.server.scheduler.main:app" --port 8092
...
from unilabos.server.storage.profiles import select_scheduler_authority_profile
...
if _inventory is not None:
    ...
    from unilabos.server.scheduler.inventory.layout import create_lab_router as _create_lab_router
